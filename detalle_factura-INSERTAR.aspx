<%@ Page Language="VB" AutoEventWireup="false" CodeFile="detalle_factura-INSERTAR.aspx.vb" Inherits="detalle_factura_INGRESAR" %>
...
<head>
    ...
    <title>Leaf :: Agregar Detalles Factura</title>
            ...
            <div class="col-md-9">
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <p><i><strong>Inserte </strong></i>los detalles de su factura, como lo son Productos y cantidades.</p>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <form id="form1" runat="server" class="form-horizontal">
                            ...
                            <h3 style="text-align: right" class="gray">Agregar Detalles Factura</h3>
                        ...
                        <!-- Formulario -->
                            ...
                            <br />
                            <a href = "detalle_factura-INSERTAR.aspx" class = "btn" role = "button"><span class="glyphicon glyphicon-erase"></span>&nbsp Limpiar</a>
