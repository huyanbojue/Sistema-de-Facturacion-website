<%@ Page Language="VB" AutoEventWireup="false" CodeFile="factura-reporte-VERI.aspx.vb" Inherits="factura_reporte_VERI" %>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <form id="form1" runat="server" class="form-horizontal">
                            ...
                            <a href="factura-BORRAR.aspx" class="btn btn-primary btn-sm" role="button"><span class="glyphicon glyphicon-triangle-left"></span>&nbsp &nbsp Regresar</a>
