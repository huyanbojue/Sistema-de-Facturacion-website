<%@ Page Language="VB" AutoEventWireup="false" CodeFile="factura-MODIFICAR.aspx.vb" Inherits="factura_MODIFICAR" %>
...
<head>
    ...
    <title>Leaf :: Modificar Factura</title>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        ...
                        <p><strong class="med-font">
                            <span class="glyphicon glyphicon-alert yellow"></span> &nbsp; &nbsp; &nbsp;Solo podra modificar Facturas que aun no tengan detalles en ella. Si no recuerda su clave de Factura <u>Consultelo.</u>
                        </p></strong>
                        </br>
                ...
                <div class="thumbnail">
                    <div class="caption-full">
                        <form id="form1" runat="server" class="form-horizontal">
                            ...
                            <h3 style="text-align: right" class="gray">Modificar Factura</h3>
                        ...
                        <!-- Formulario -->
                            ...
                            <br />
                            <a href = "factura-MODIFICAR.aspx" class = "btn" role = "button"><span class="glyphicon glyphicon-erase"></span>&nbsp Limpiar</a>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FacturacionConnectionString %>" SelectCommand="MODIFICAR_FACTURA" SelectCommandType="StoredProcedure">
                                <SelectParameters>
